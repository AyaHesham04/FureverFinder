...
export default function Card({ name, gender, imageSrc }) {
  return (
    <div className="max-[430px]:w-[120px] max-[560px]:h-[200px] w-[190px] h-[270px] md:w-[190px] md:h-[260px] 2xl:w-[280px] 2xl:h-[400px] bg-pink-button p-2 rounded-[30px] shadow-lg">
