  ...
  return (
    ...
    >
      ...
      <div className="flex justify-between items-center mt-4 2xl:mt-5">
        <h2 onClick={handleCardClick} className="p-1 text-[20px] max-[430px]:text-[16px] lg:text-[24px] xl:text-[24px] 2xl:text-[30px] font-poppins font-semibold leading-[36px] tracking-[1%] text-[#5F5B5B]">
          {pet.name}
        </h2>
        <div className="flex items-center">
          {pet.canDelete ? (
            <div className="flex items-center space-x-4">
              <img
                src={editIcon}
                className="w-9 h-9 bg-white cursor-pointer"
                alt="edit icon"
