...
const FilterBar = () => {
  ...
  for (let i = 0; i < 12; i++) {
    ageOptions.push({ value: `${i}`, label: `${i} ${i === 1 ? 'month' : 'months'}` });
  }

  // Generate options for years (1 year to 20 years)
  for (let i = 1; i <= 20; i++) {
    ageOptions.push({ value: `${i * 12}`, label: `${i} ${i === 1 ? 'year' : 'years'}` });
  }
    ...
    <div className="mx-5 sm:mx-8 mt-4">
      <div className="bg-[#F5F5F5] w-full grid sm:grid-cols-[2fr_1fr] grid-cols-[3fr_0.5fr] max-[400px]:grid-cols-[4fr_0.1fr] lg:gap-x-10 gap-x-2 items-center justify-center rounded-lg 2xl:text-[19px] xl:text-[17px] lg:text-[15px] md:text-[14px] sm:text-[11px] max-[430px]:text-[9px]">
        <div className="w-full font-inter font-[700] grid grid-cols-3 gap-3 max-[430px]:gap-1 p-3 max-[430px]:p-1 text-black">
          <div ref={dropdownRef} className="relative grid grid-cols-[0.5fr_1fr_0.5fr] mx-auto w-full justify-center items-center bg-[#E9E9E9] rounded-lg p-3  max-[430px]:p-1 text-center">
            <img src={pet} alt="Pet" className="mx-auto 2xl:w-8 2xl:h-8 xl:w-8 xl:h-8 lg:w-7 lg:h-7 md:w-6 md:h-6 sm:w-4 sm:h-4 max-[430px]:w-3 max-[430px]:h-3" />
            <div className="mx-auto">Pet</div>
            <div onClick={togglePetDropdown} className="transition-transform mx-auto">
              <svg
          ...
          <div ref={dropdownRef} className="relative grid grid-cols-[0.5fr_1fr_0.5fr] mx-auto w-full justify-center items-center bg-[#E9E9E9] rounded-lg p-3  max-[430px]:p-1 text-center">
            <img src={gender} alt="Gender" className="mx-auto 2xl:w-8 2xl:h-8 xl:w-8 xl:h-8 lg:w-7 lg:h-7 md:w-6 md:h-6 sm:w-4 sm:h-4 max-[430px]:w-3 max-[430px]:h-3" />
            <div className="mx-auto">Gender</div>
            <div onClick={toggleGenderDropdown} className="transition-transform mx-auto">
              <svg
                xmlns="http://www.w3.org/2000/svg"
          ...
          <div ref={dropdownRef} className="relative grid grid-cols-[0.5fr_1fr_0.5fr] mx-auto w-full justify-center items-center bg-[#E9E9E9] rounded-lg p-3  max-[430px]:p-1 text-center">
            <img src={age} alt="Age" className="mx-auto 2xl:w-8 2xl:h-8 xl:w-8 xl:h-8 lg:w-7 lg:h-7 md:w-6 md:h-6 sm:w-4 sm:h-4 max-[430px]:w-3 max-[430px]:h-3" />
            <div className="mx-auto">Age</div>
            <div onClick={toggleAgeDropdown} className="transition-transform mx-auto">
              <svg
                xmlns="http://www.w3.org/2000/svg"
        ...
        <div className="w-full grid grid-cols-[1.5fr_1fr] sm:grid-cols-[1fr_1fr] max-[430px]:grid-col-1 font-inter p-3 max-[430px]:p-2 max-[400px]:p-1 items-center max-[430px]:justify-center">
          <input type="text" placeholder="Search pets..." className="text-[#4242425C] font-[400] block max-[430px]:hidden bg-[#F5F5F5]" />
          <div className="bg-pink-button border border-[rgba(95,91,91,0.3)] hover:bg-[#7BCFD180] text-white font-[700] w-full inline-block rounded-lg p-2 max-[430px]:p-1 max-[430px]:w-fit text-center shadow-md">
            <button className="flex justify-center items-center w-fit">
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="white" className="2xl:w-8 2xl:h-8 xl:w-8 xl:h-8 lg:w-7 lg:h-7 md:w-5 md:h-5 sm:w-4 sm:h-4 max-[430px]:w-3 max-[430px]:h-3 inline-block mr-2 max-[430px]:mr-0">
                <path fill-rule="evenodd" d="M10 2a8 8 0 105.293 14.707l4.853 4.853a1 1 0 101.414-1.414l-4.853-4.853A8 8 0 0010 2zm0 2a6 6 0 100 12 6 6 0 000-12z" clip-rule="evenodd" />
              </svg>
